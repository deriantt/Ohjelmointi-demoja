...
public class Pvm implements Comparable<Object> {
     ...
     *  Todo: pit‰‰ vaihtaa hakemaan p‰iv‰m‰‰r‰ oikeasti. --- Nyt hakee
     *  Mutta perinn‰ss‰k‰‰n ei nyt saa k‰ytt‰‰ enemp‰‰ attribuutteja kuin t‰ss‰ on
     */
    public void paivays() {
        Calendar kalenteri = Calendar.getInstance(); 
        pv = kalenteri.get(Calendar.DAY_OF_WEEK);
    ...
    public int compareTo(Pvm pvm2) {
        ...
        if ( getPv() > pvm2.getPv() ) return 1;
        return 0;
        //  return compare(this,pvm2);    // Olisi helpoin jos on staattinen metodi
    ...
    public static int compareTo(Pvm pvm1, Pvm pvm2) {
        ...
        if ( pvm1.getPv() > pvm2.getPv() ) return 1;
        return 0;
        //  return pvm1.compare(pvm2);  // Helpoin olisi
    }
